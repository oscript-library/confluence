...
Функция НайтиСтраницуПоИмени(ПараметрыПодключения, КодПространства, ИмяСтраницы) Экспорт
	...
	Лог.Отладка("Поиск страницы [%1]", ИмяСтраницы);
	...
	Если ЗначениеЗаполнено(Идентификатор) Тогда
		...
		Лог.Отладка("Найдена страница [%1], идентификатор: %2", ИмяСтраницы, Идентификатор);
	
	Иначе

		Лог.Отладка("Не найдена страница [%1]", ИмяСтраницы);
...
Функция ВерсияСтраницыПоИдентификатору(ПараметрыПодключения, Идентификатор) Экспорт
	...
	Лог.Отладка("Получение версии страницы %1", Идентификатор);
	...
	Лог.Отладка("Версия страницы %1", Версия);
...
Функция СодержимоеСтраницыПоИдентификатору(ПараметрыПодключения, Идентификатор) Экспорт
	...
	Лог.Отладка("Получение содержимого страницы %1", Идентификатор);
...
Функция СоздатьСтраницу(ПараметрыПодключения, КодПространства, ИмяСтраницы, Содержимое, ИдентификаторРодителя = "") Экспорт
	...
	Иначе
		...
		ВызватьИсключение "СоздатьСтраницу: Ошибка создания страницы:" + КодПространства + "." + ИмяСтраницы + ТекстОшибки(РезультатЗапроса, URL, "POST");
...
Функция Создать(ПараметрыПодключения, АдресСтраницы, Содержимое = Неопределено) Экспорт
	...
	Лог.Отладка("Создание страницы [%1] (%2)", АдресСтраницы.ИмяСтраницы, АдресСтраницы.Идентификатор);
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон("Создать: Ошибка создания страницы: %1.%2%3",
	...
	Лог.Отладка("Создана страница [%1] (%2)", АдресСтраницы.ИмяСтраницы, АдресСтраницы.Идентификатор);
...
Функция Обновить(ПараметрыПодключения, АдресСтраницы, Содержимое = Неопределено, ОбновитьПриИзмененииСодержимого = Ложь) Экспорт
	...
	Лог.Отладка("Обновление страницы [%1] (%2)", АдресСтраницы.ИмяСтраницы, АдресСтраницы.Идентификатор);
	...
	Если ОбновитьПриИзмененииСодержимого Тогда
		...
		Если СтрСравнить(СокрЛП(СодержимоеConfluence), СокрЛП(ВрСодержимое)) = 0 Тогда
			...
			Лог.Отладка("Содержимое страницы не отличается, обновление не трабуется");
			Возврат Неопределено;

		КонецЕсли;

		Лог.Отладка("Содержимое страницы изменилось");
	...
	Лог.Отладка("Обновлена страница %1", АдресСтраницы.Идентификатор);
...
Функция СоздатьИлиОбновить(ПараметрыПодключения, АдресСтраницы, Содержимое, ОбновитьПриИзмененииСодержимого) Экспорт
	...
	Лог.Отладка("> СоздатьИлиОбновить %1", АдресСтраницы.ИмяСтраницы);
...
Функция ПараметрыСозданияОбновления(Адрес, ОписаниеСодержимого, Версия = Неопределено)
	...
	ФорматПоУмолчанию = ФорматыСодержимого.Confluence;
	Значение = "";
...
Функция ВыполнитьHTTPЗапрос(ПараметрыПодключения, Метод, URL, ТелоЗапроса = "", Accept = "application/json; charset=UTF-8")
	...
	Лог.Отладка("REQUEST - %1 %2", Метод, URL);
...
Лог = Логирование.ПолучитьЛог("oscript.lib.confluence");
